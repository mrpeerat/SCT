...
class ARL_DIS_Loss_v2(nn.Module):
    def __init__(self, instanceQ, teacher_temp, model, lambda_val, beta_val, sentence_embedding_dimension, moving_average_decay=0.999, student_temp=0.05, device=None, batch_size=128):
        ...
        """
        super(ARL_DIS_Loss_v2, self).__init__()
        ...
        self.all_sizes = instanceQ.shape[0]+batch_size
    ...
    def forward(self, 
        ...
        with torch.no_grad():
            ...
            rep_sent_momentum = F.normalize(rep_sent_momentum, p=2, dim=1)
