...
class ParallelSentencesDatasetForSEEDER(Dataset):
    """
    ...
    def generate_data(self):
        ...
        for src_embedding, src_sentences, trg_sentences in zip(src_embeddings, source_sentences_list, target_sentences_list):
            for trg_sentence in trg_sentences:
                self.cache.append(InputExample(texts=[trg_sentence, src_sentences], label=src_embedding))
